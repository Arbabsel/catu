...
async def meme(event):
    ...
    await asyncio.sleep(sleepValue)
    await event.edit("____________" + memeVar + "__")
    await asyncio.sleep(sleepValue)
    await event.edit("___________" + memeVar + "___")
    await asyncio.sleep(sleepValue)
    await event.edit("__________" + memeVar + "____")
    await asyncio.sleep(sleepValue)
    await event.edit("_________" + memeVar + "_____")
    await asyncio.sleep(sleepValue)
    await event.edit("________" + memeVar + "______")
    await asyncio.sleep(sleepValue)
    await event.edit("_______" + memeVar + "_______")
    await asyncio.sleep(sleepValue)
